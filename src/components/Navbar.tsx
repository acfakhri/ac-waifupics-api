  ...
  return (
    <nav className="bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 py-3 md:py-6 flex justify-between items-center">
        {/* Logo */}
        <div>
          <a href="/" className="text-white text-lg font-bold">Nyanko-Nyan`</a>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <Link to={'/popular'} className="text-gray-300" >Popular</Link>
      ...
      <div className={`md:hidden ${isOpen ? 'block' : 'hidden'} bg-gray-800`}>
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <Link to={'/popular'} className="block text-gray-300 py-2 px-4">Popular</Link>
