  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-center mb-4">
        <button
          className={`mr-4 px-4 py-2 rounded ${category === 'sfw' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-800'}`}
          onClick={() => handleCategoryChange('sfw')}
        >
          SFW
        </button>
        <button
          className={`px-4 py-2 rounded ${category === 'nsfw' ? 'bg-red-500 text-white' : 'bg-gray-200 text-gray-800'}`}
